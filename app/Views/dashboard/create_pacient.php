...
<form id="pacient-id" action="<?= base_url('PacientController/save'); ?>" method="post">
    <?= csrf_field(); ?>
    ...
    <div class="tabs-holder">
        <ul class="tabs-nav">
            <li class="active-nav"><a href="#">Информация за пациента</a></li>
            <li><a href="#">Данни за заболяването - Болест на Паркинсон</a></li>
            <li><a href="#">Включване на пациент на медикамент по програмата</a></li>
            <li><a href="#">Титриране на пациент на медикамент по програмата </a></li>
            <li><a href="#">Консумативи по програмата</a></li>
            <li><a href="#"> Включване на пациент на медикамент по програмата по процедури на НЗОК</a></li>
            <li><a href="#">Поддържане на пациент на медикамент по програмата според процедурите на НЗОК </a></li>
            <li><a href="#">Комуникация от служител на МЦ Раредис с пациент по програмата</a></li>
        </ul>
        ...
        <div class="tab-content active-content">
            <div class="form-group">
                <label for="pacient_id">
                    ...
                    <input id="pacient_id" type="text" class="input-bg" name="pacient_id" value="<?= set_value('pacient_id'); ?>" >
                </label>

                <label for="pacient_name">
                    ...
                    <input id="pacient_name" type="text" class="input-bg" name="pacient_name" value="<?= set_value('pacient_name'); ?>" >
                </label>
            </div>
            ...
            <div class="form-group">
                <label for="egn">
                    ...
                    <input id="egn" type="text" class="input-bg"  name="egn" value="<?= set_value('egn'); ?>" >
                </label>

                <label for="pacient_birthday">
                    ...
                    <input id="pacient_birthday" min="1900-01-01"  placeholder="dd-mm-yyyy" type="date" class="input-bg"  name="pacient_birthday" value="<?= set_value('pacient_birthday'); ?>" >
            ...
            <div class="form-group">
                <label for="pacient_phone">
                    ...
                    <input id="pacient_phone" type="text" class="input-bg" name="pacient_phone" value="<?= set_value('pacient_phone'); ?>" >
                </label>

                <label for="pacient_post_add">
                    ...
                    <input id="pacient_post_add" type="text" class="input-bg" name="pacient_post_add" value="<?= set_value('pacient_post_add'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="pacient_email">
                    ...
                    <input id="pacient_email" type="text" class="input-bg" name="pacient_email" value="<?= set_value('pacient_email'); ?>" >
                </label>

                <label for="pacient_pridrujitel">
                    ...
                    <input id="pacient_pridrujitel" type="text" class="input-bg" name="pacient_pridrujitel" value="<?= set_value('pacient_pridrujitel'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="pridrujitel_status">
                    ...
                    <input id="pridrujitel_status" type="text" class="input-bg" name="pridrujitel_status" value="<?= set_value('pridrujitel_status'); ?>" >
                </label>

                <label for="pridrujitel_phone">
                    ...
                    <input id="pridrujitel_phone" type="text" class="input-bg" name="pridrujitel_phone" value="<?= set_value('pridrujitel_phone'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="lekar_na_pacient">
                    ...
                    <input id="lekar_na_pacient" type="text" class="input-bg"  name="lekar_na_pacient" value="<?= set_value('lekar_na_pacient'); ?>" >
                </label>

                <label for="lekar_nomer">
                    ...
                    <input id="lekar_nomer" type="text" class="input-bg"  name="lekar_nomer" value="<?= set_value('lekar_nomer'); ?>" >
                </label>
            </div>
            ...
            <div class="form-group">
                <label for="nevrolog">
                    ...
                    <input id="nevrolog" type="text" class="input-bg"  name="nevrolog" value="<?= set_value('nevrolog'); ?>" >
                </label>

                <label for="nevrolog_phone">
                    ...
                    <input id="nevrolog_phone" type="text" class="input-bg"  name="nevrolog_phone" value="<?= set_value('nevrolog_phone'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="lice_podalo_inf">
                    ...
                    <input id="lice_podalo_inf" type="text" class="input-bg"  name="lice_podalo_inf" value="<?= set_value('lice_podalo_inf'); ?>" >
                </label>

                <label for="statut_na_lice_podalo">
                    ...
                    <input id="statut_na_lice_podalo" type="text" class="input-bg" name="statut_na_lice_podalo" value="<?= set_value('statut_na_lice_podalo'); ?>" >
                </label>
            </div>
            ...
            <div class="form-group">
                <label for="statut_na_lice_podalo">
                    ...
                    <span class="text-danger"><?= isset($validation) ? display_error($validation, 'statut_na_lice_podalo') : '' ?></span>
                    <select name="informacia_syglasie" id="informacia_syglasie" class="input-bg">
        ...
        <div class="tab-content">
            <div class="form-group">
                <label for="diagnoza">
                    ...
                    <textarea id="diagnoza" type="text" class="textarea input-bg" name="diagnoza" cols="30" rows="10"></textarea>
                </label>

                <label for="godina_na_diagnoza">
                    ...
                    <input id="godina_na_diagnoza"  type="date" class="input-bg" name="godina_na_diagnoza" value="<?= set_value('godina_na_diagnoza'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="dozirovka_tabletki">
                    ...
                    <input id="dozirovka_tabletki" type="text" class="input-bg" name="dozirovka_tabletki" value="<?= set_value('dozirovka_tabletki'); ?>" >
                </label>
                ...
                <label for="godina_na_diagnoza">
                    ...
                    <select class="input-bg" name="statut_na_pacienta" id="statut_na_pacienta">
            ...
            <div class="form-group">
                <label for="poiasninie_na_statut">
                    ...
                    <input id="poiasninie_na_statut" type="text" class="input-bg" name="poiasninie_na_statut" value="<?= set_value('poiasninie_na_statut'); ?>" >
                </label>
            </div>
        </div><!--end  tab-content -->
        ...
        <div class="tab-content">
            <div class="form-group">
                <label for="nomer_na_pompa">
                    ...
                    <input id="nomer_na_pompa" type="text" class="input-bg" name="nomer_na_pompa" value="<?= set_value('nomer_na_pompa'); ?>" >
                </label>

                <label for="versia_na_pompa">
                    ...
                    <input id="versia_na_pompa" type="text" class="input-bg" name="versia_na_pompa" value="<?= set_value('versia_na_pompa'); ?>" >
                </label>
            </div>
            ...
            <div class="form-group">
                <label for="versia_na_pompa">
                    ...
                    <input id="data_na_postaviane_peg" type="date" class="input-bg" name="data_na_postaviane_peg" value="<?= set_value('data_na_postaviane_peg'); ?>" >
                </label>

                <label for="data_zapochvane_nis">
                    ...
                    <input id="data_zapochvane_nis" type="date" class="input-bg" name="data_zapochvane_nis" value="<?= set_value('data_zapochvane_nis'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="medicinsko_zavedenie_peg">
                    ...
                    <input id="medicinsko_zavedenie_peg" type="text" class="input-bg" name="medicinsko_zavedenie_peg" value="<?= set_value('medicinsko_zavedenie_peg'); ?>" >
                </label>

                <label for="gastroenterolog_peg">
                    ...
                    <input id="gastroenterolog_peg" type="text" class="input-bg" name="gastroenterolog_peg" value="<?= set_value('gastroenterolog_peg'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="data_na_postaviane_peg">
                    <div class="input-title">Дата на първоначално поставяне на ПЕГ</div>
                    <span class="text-danger"><?= isset($validation) ? display_error($validation, 'data_na_postaviane_peg') : '' ?></span>
                    <input id="data_na_postaviane_peg" type="date" class="input-bg" name="data_na_postaviane_peg" value="<?= set_value('data_na_postaviane_peg'); ?>" >
                </label>

                <label for="data_za_podmiana_peg">
                    ...
                    <input id="data_za_podmiana_peg" type="date" class="input-bg" name="data_za_podmiana_peg" value="<?= set_value('data_za_podmiana_peg'); ?>" >
                </label>
            </div>
            ...
            <div class="form-group">
                <label for="fiksirana_tryba">
                    ...
                    <input id="fiksirana_tryba" type="text" class="input-bg" name="fiksirana_tryba" value="<?= set_value('fiksirana_tryba'); ?>" >
                </label>
                ...
                <label for="fiksirana_tryba">
                    ...
                    <input id="data_na_Izpisvane" type="date" class="input-bg" name="data_na_Izpisvane" value="<?= set_value('data_na_Izpisvane'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="prichina_za_spirane_terapia">
                    ...
                    <input id="prichina_za_spirane_terapia" type="text" class="input-bg" name="prichina_za_spirane_terapia" value="<?= set_value('prichina_za_spirane_terapia'); ?>" >
                </label>

                <label for="otpadnal_pacient">
                    ...
                    <input id="	otpadnal_pacient" type="date" class="input-bg" name="otpadnal_pacient" value="<?= set_value('otpadnal_pacient'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="prichina_za_otpadnal">
                    ...
                    <input id="	prichina_za_otpadnal" type="text" class="input-bg" name="prichina_za_otpadnal" value="<?= set_value('prichina_za_otpadnal'); ?>" >
                </label>
            </div>
        </div><!--end tab-content-->
        ...
        <div class="tab-content">
                <div class="form-group">
                    <label for="terapia">
                        ...
                        <input id="terapia" type="text" class="input-bg" name="terapia" value="<?= set_value('terapia'); ?>" >
                    </label>

                    <label for="dozirovka">
                        <div class="input-title">Дозировка</div>
                        <span class="text-danger"><?= isset($validation) ? display_error($validation, 'dozirovka') : '' ?></span>
                        <textarea name="dozirovka" class="textarea input-bg" id="dozirovka" cols="30" rows="10"></textarea>
                    </label>
                </div>

                <div class="form-group">
                    <label for="data_na_dozirovka_startirane">
                        ...
                        <input id="data_na_dozirovka_startirane" type="date" class="input-bg" name="data_na_dozirovka_startirane" value="<?= set_value('data_na_dozirovka_startirane'); ?>" >
                    </label>

                    <label for="dosirovki_pri_startirane">
                        ...
                        <input id="dosirovki_pri_startirane" type="text" class="input-bg" name="dosirovki_pri_startirane" value="<?= set_value('dosirovki_pri_startirane'); ?>" >
                    </label>
                </div>

                <div class="form-group">
                    <label for="data_izpisvane">
                        ...
                        <input id="data_izpisvane" type="date" class="input-bg" name="data_izpisvane" value="<?= set_value('data_izpisvane'); ?>" >
                    </label>

                    <label for="dozirovki_na_data_izpisvane">
                        ...
                        <textarea name="dozirovki_na_data_izpisvane" id="dozirovki_na_data_izpisvane" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>
                </div>

                <div class="form-group">
                    <label for="data_dozirovki">
                        ...
                        <textarea name="data_dozirovki" id="data_dozirovki" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>

                    <label for="data_dozirovki_2">
                        <div class="input-title">Дата/Дозировки</div>
                        <span class="text-danger"><?= isset($validation) ? display_error($validation, 'data_dozirovki_2') : '' ?></span>
                        <textarea name="data_dozirovki_2" id="data_dozirovki_2" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>
                </div>

                <div class="form-group">
                    <label for="data_dozirovki_3">
                        <div class="input-title">Дата/Дозировки</div>
                        <span class="text-danger"><?= isset($validation) ? display_error($validation, 'data_dozirovki_3') : '' ?></span>
                        <textarea name="data_dozirovki_3" id="data_dozirovki_3" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>

                    <label for="data_dozirovki_4">
                        <div class="input-title">Дата/Дозировки</div>
                        <span class="text-danger"><?= isset($validation) ? display_error($validation, 'data_dozirovki_4') : '' ?></span>
                        <textarea name="data_dozirovki_4" id="data_dozirovki_4" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>
                </div>

                <div class="form-group">
                    <label for="data_dozirovki_5">
                        <div class="input-title">Дата/Дозировки</div>
                        <span class="text-danger"><?= isset($validation) ? display_error($validation, 'data_dozirovki_5') : '' ?></span>
                        <textarea name="data_dozirovki_5" id="data_dozirovki_5" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>
                </div>
            ...
            <div class="tab-content">
                <div class="form-group">
                    <label for="tip_pompa">
                        ...
                        <select name="tip_pompa" id="tip_pompa">
                    ...
                    <label for="serien_pompa">
                        ...
                        <textarea name="serien_pompa" id="serien_pompa" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>
                </div>

                <div class="form-group">
                    <label for="srok_godnost_pompa">
                        ...
                        <textarea name="serien_pompa" id="srok_godnost_pompa" class="textarea input-bg" cols="30" rows="10"></textarea>

                        <input id="srok_godnost_pompa" type="text" class="input-bg" name="srok_godnost_pompa" value="<?= set_value('srok_godnost_pompa'); ?>" >
                    </label>

                    <label for="data_na_predavane">
                        ...
                        <textarea name="data_na_predavane" id="data_na_predavane" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>
                </div>


                <div class="form-group">
                    <label for="serien_nomer_vyrnata">
                        ...
                        <input id="serien_nomer_vyrnata" type="text" class="input-bg" name="serien_nomer_vyrnata" value="<?= set_value('serien_nomer_vyrnata'); ?>" >
                    </label>


                    <label for="data_na_prietata_pompa">
                        ...
                        <input id="data_na_prietata_pompa" type="date" class="input-bg" name="data_na_prietata_pompa" value="<?= set_value('data_na_prietata_pompa'); ?>" >
                    </label>
                </div>

                <div class="form-group">
                    <label for="komentar_prichina">
                        ...
                        <textarea name="komentar_prichina" id="komentar_prichina" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>

                    <label for="otgovorno_lice_pompata">
                        ...
                        <input id="otgovorno_lice_pompata" type="text" class="input-bg" name="otgovorno_lice_pompata" value="<?= set_value('otgovorno_lice_pompata'); ?>" >
                    </label>

                </div>

                <div class="form-group">
                    <label for="data_za_remont">
                        ...
                        <input id="data_za_remont" type="date" class="input-bg" name="data_za_remont" value="<?= set_value('data_za_remont'); ?>" >
                    </label>
                    ...
                    <label for="otgovorno_lice_pompata">
                        ...
                        <input id="data_za_poluchavane_remont" type="text" class="input-bg" name="data_za_poluchavane_remont" value="<?= set_value('data_za_poluchavane_remont'); ?>" >
                    </label>
                </div>
                ...
                <div class="form-group">
                    <label for="komentar">
                        ...
                        <span class="text-danger"><?= isset($validation) ? display_error($validation, 'data_za_remont') : '' ?></span>
                        <textarea name="komentar" id="komentar" class="textarea input-bg" cols="30" rows="10"></textarea>
                    </label>

                    <label for="predostavena_hladilna_chanta">
                        ...
                        <input id="predostavena_hladilna_chanta" type="date" class="input-bg" name="predostavena_hladilna_chanta" value="<?= set_value('predostavena_hladilna_chanta'); ?>" >
                    </label>
                </div>

                <div class="form-group">
                    <label for="predostavena_hladilna_chanta_protokol">
                        ...
                        <input id="predostavena_hladilna_chanta_protokol" type="date" class="input-bg" name="predostavena_hladilna_chanta_protokol" value="<?= set_value('predostavena_hladilna_chanta_protokol'); ?>" >
                    </label>
                </div>
            ...
            <div class="tab-content">
                <div class="form-group">
                    <label for="data_na_hospitalizacia_medicinsko_odobrenie">
                        ...
                        <input id="data_na_hospitalizacia_medicinsko_odobrenie" type="date" class="input-bg" name="data_na_hospitalizacia_medicinsko_odobrenie" value="<?= set_value('data_na_hospitalizacia_medicinsko_odobrenie'); ?>" >
                    </label>

                    <label for="medicinsko_zavedenie_predvaritelno_odobrenie">
                        ...
                        <input id="medicinsko_zavedenie_predvaritelno_odobrenie" type="text" class="input-bg" name="medicinsko_zavedenie_predvaritelno_odobrenie" value="<?= set_value('medicinsko_zavedenie_predvaritelno_odobrenie'); ?>" >
                    </label>
                </div>

                <div class="form-group">
                    <label for="data_za_zapisvane_na_pacient">
                        ...
                        <input id="data_za_zapisvane_na_pacient" type="date" class="input-bg" name="data_za_zapisvane_na_pacient" value="<?= set_value('data_za_zapisvane_na_pacient'); ?>" >
                    </label>

                    <label for="reshenie_na_ekspertna_lekarska_komisia">
                        ...
                        <input id="reshenie_na_ekspertna_lekarska_komisia" type="date" class="input-bg" name="reshenie_na_ekspertna_lekarska_komisia" value="<?= set_value('reshenie_na_ekspertna_lekarska_komisia'); ?>" >
                    </label>
                </div>

                <div class="form-group">
                    <label for="data_za_podavane_rzok">
                        ...
                        <input id="data_za_podavane_rzok" type="date" class="input-bg" name="data_za_podavane_rzok" value="<?= set_value('data_za_podavane_rzok'); ?>" >
                    </label>

                    <label for="data_za_uvedomlenie_rzok">
                        ...
                        <input id="data_za_uvedomlenie_rzok" type="text" class="input-bg" name="data_za_uvedomlenie_rzok" value="<?= set_value('data_za_uvedomlenie_rzok'); ?>" >
                    </label>
                </div>

                <div class="form-group">
                    <label for="broy_kalendarni_dni_rzok">
                        ...
                        <input id="broy_kalendarni_dni_rzok" type="text" class="input-bg" name="broy_kalendarni_dni_rzok" value="<?= set_value('broy_kalendarni_dni_rzok'); ?>" >
                    </label>

                    <label for="broy_kalendarni_dni_rzok">
                        <div class="input-title">Аптека за получаване на медикамент по програмата</div>
                        <span class="text-danger"><?= isset($validation) ? display_error($validation, 'broy_kalendarni_dni_rzok') : '' ?></span>
                        <textarea name="anketa_za_medikamenti" class="textarea input-bg" id="anketa_za_medikamenti" cols="30" rows="10"></textarea>
                    </label>
                </div>
            </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group">
                        <label for="protokol_nomer">
                            <div class="input-title">Протокол N</div>
                            <span class="text-danger"><?= isset($validation) ? display_error($validation, 'protokol_nomer') : '' ?></span>
                            <input id="protokol_nomer" type="text" class="input-bg" name="protokol_nomer" value="<?= set_value('protokol_nomer'); ?>" >
                        </label>

                        <label for="data_na_podaden_protokol_nzok">
                            ...
                            <input id="data_na_podaden_protokol_nzok" type="date" class="input-bg" name="data_na_podaden_protokol_nzok" value="<?= set_value('data_na_podaden_protokol_nzok'); ?>" >
                        </label>
                    </div>

                    <div class="form-group">
                        <label for="data_poluchen_protokol_nzok">
                            ...
                            <input id="data_poluchen_protokol_nzok" type="date" class="input-bg" name="data_poluchen_protokol_nzok" value="<?= set_value('data_poluchen_protokol_nzok'); ?>" >
                        </label>

                        <label for="protokol_validen">
                            ...
                            <input id="protokol_validen" type="date" class="input-bg" name="protokol_validen" value="<?= set_value('protokol_validen'); ?>" >
                        </label>
                    </div>


                    <div class="form-group">
                        <label for="data_za_sledvasht_protokol">
                            ...
                            <input id="data_za_sledvasht_protokol" type="date" class="input-bg" name="data_za_sledvasht_protokol" >
                        </label>

                        <label for="dni_do_podavane_za_protokol">
                            ...
                            <input id="dni_do_podavane_za_protokol" type="text" class="input-bg" name="dni_do_podavane_za_protokol" value="<?= set_value('dni_do_podavane_za_protokol'); ?>" >
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="dni_na_pyrva_RP">
                            ...
                            <input id="dni_na_pyrva_RP" type="date" class="input-bg" name="dni_na_pyrva_RP" value="<?= set_value('dni_na_pyrva_RP'); ?>" >
                        </label>
                    </div>
        ...
        <div class="tab-content">
            <div class="form-group">
                <label for="slujitel_ime">
                    ...
                    ') : '' ?></span>
                    <input id="slujitel_ime" type="text" class="input-bg" name="slujitel_ime" value="<?= set_value('slujitel_ime'); ?>" >
                </label>

                <label for="data_raredis">
                    <div class="input-title">Дата</div>
                    <span class="text-danger"><?= isset($validation) ? display_error($validation, 'data_raredis') : '' ?></span>
                    <input id="data_raredis" type="date" class="input-bg" name="data_raredis" value="<?= set_value('data_raredis'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="chas_raredis">
                    <div class="input-title">Час</div>
                    <span class="text-danger"><?= isset($validation) ? display_error($validation, 'chas_raredis') : '' ?></span>
                    <input id="chas_raredis" type="text" class="input-bg" name="chas_raredis" value="<?= set_value('chas_raredis'); ?>" >
                </label>
                ...
                <label for="chas_raredis">
                    ...
                    <select name="kom_kanal"  class="input-bg"  id="kom_kanal">
            ...
            <div class="form-group">
                <label for="povod">
                    ...
                    <select name="povod"  class="input-bg"  id="povod">
                ...
                <label for="raredis_komentar">
                    <div class="input-title">Коментар</div>
                    <span class="text-danger"><?= isset($validation) ? display_error($validation, 'raredis_komentar') : '' ?></span>
                    <textarea name="raredis_komentar" class="textarea input-bg" id="raredis_komentar" cols="30" rows="10"></textarea>
                </label>
            </div>


            <div class="form-group">
                <label for="podgotvena_dokumentacia">
                    <div class="input-title">Повод</div>
                    <span class="text-danger"><?= isset($validation) ? display_error($validation, 'podgotvena_dokumentacia') : '' ?></span>
                    <select name="podgotvena_dokumentacia"  class="input-bg"  id="podgotvena_dokumentacia">
                        <option value="<?= set_value('Да') ?>">Да</option>
                        <option value="<?= set_value('Не') ?>">Не</option>
                    </select>
                </label>
                ...
                <label for="chas_raredis">
                    ...
                    <input id="vid_dokumentacia" type="text" class="input-bg" name="vid_dokumentacia" value="<?= set_value('vid_dokumentacia'); ?>" >
                </label>
            </div>

            <div class="form-group">
                <label for="raredis_komentar_2">
                    <div class="input-title">Коментар</div>
                    <span class="text-danger"><?= isset($validation) ? display_error($validation, 'raredis_komentar_2') : '' ?></span>
                    <textarea name="raredis_komentar_2" class="textarea input-bg" id="raredis_komentar_2" cols="30" rows="10"></textarea>
                </label>

                <label for="nomer_protokol_dokladvan">
                    ...
                    <input id="nomer_protokol_dokladvan" type="text" class="input-bg" name="nomer_protokol_dokladvan" value="<?= set_value('nomer_protokol_dokladvan'); ?>" >
                </label>
            </div>


            <div class="form-group">
                <label for="opisanie_prichina">
                    ...
                    <input id="opisanie_prichina" type="text" class="input-bg" name="opisanie_prichina" value="<?= set_value('opisanie_prichina'); ?>" >
                </label>

                <label for="nlr_dokladvan">
                    ...
                    <textarea name="nlr_dokladvan" class="textarea input-bg" id=nlr_dokladvan" cols="30" rows="10">
