...
<form id="pacient-id" action="<?= site_url('PacientController/save'); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="age" class="d-block">
                                ...
                                <input id="age" type="text" class="form-control form-control-user"  name="age" value="<?= set_value('age'); ?>" >
                            </label>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="diagnoza" class="d-block">
                                ...
                                <textarea id="diagnoza" type="text" class="form-control form-control-user" name="diagnoza" cols="30" rows="10"></textarea>
                            </label>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="otgovorno_lice_pompata" class="d-block">
                                    ...
                                    <input id="data_za_poluchavane_remont" type="text" class="form-control form-control-user" name="data_za_poluchavane_remont" value="<?= set_value('data_za_poluchavane_remont'); ?>" >
                                </label>
                            </div>
                        </div>
    ...
    <div class="d-flex justify-content-center">
        <input type="submit" name="submit" value="Запис на данните" class="btn btn-primary big-btn">
    </div>
</form>
<?= $this->endSection(); ?>