        ...
        <div class="tab-content mt-5">
            ...
            <div id="ex1-tabs-1" class="tab-pane fade show active">
                ...
                <div class="form-group">
                   <div class="row">
                       <div class="col-md-6">
                            <label for="age" class="d-block">
                                <div class="input-title">Възраст (години)</div>
                                <span class="text-danger"><?= isset($validation) ? display_error($validation, 'age') : '' ?></span>
                                <input id="age" type="text" class="form-control form-control-user"  name="age" value="<?= esc($pacient['age']); ?>" >
                            </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="diagnoza" class="d-block">
                                ...
                                <textarea id="diagnoza" type="text" class="textarea form-control form-control-user full-width" name="diagnoza" cols="30" rows="10"></textarea>
                            </label>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="versia_na_pompa" class="d-block">
                                ...
                                <input id="data_na_postaviane_peg"
                                    ...
                                    value="<?= esc($pacient['data_na_postaviane_peg']); ?>" >
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label for="data_zapochvane_nis" class="d-block">
                                ...
                                <input id="data_zapochvane_nis"
                                    ...
                                    value="<?= esc($pacient['data_zapochvane_nis']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_za_podmiana_peg" class="d-block">
                                ...
                                <input id="data_za_podmiana_peg"
                                    ...
                                    value="<?= esc($pacient['data_za_podmiana_peg']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="fiksirana_tryba" class="d-block">
                                ...
                                <input id="data_na_Izpisvane"
                                    ...
                                    value="<?= esc($pacient['data_na_Izpisvane']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="otpadnal_pacient" class="d-block">
                                ...
                                <input id="	otpadnal_pacient"
                                    ...
                                    value="<?= esc($pacient['otpadnal_pacient']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_na_dozirovka_startirane" class="d-block">
                                ...
                                <input id="data_na_dozirovka_startirane"
                                    ...
                                    value="<?= esc($pacient['data_na_dozirovka_startirane']); ?>" >
                            </label>
                        </div>
                        <div class="col-md-6">
            ...
            <div id="ex1-tabs-5" class="tab-pane fadet">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6" class="d-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="otgovorno_lice_pompata" class="d-block">
                                ...
                                <input id="data_za_poluchavane_remont" type="text" class="form-control form-control-user" name="data_za_poluchavane_remont" value="<?= esc($pacient['data_za_poluchavane_remont']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="predostavena_hladilna_chanta" class="d-block">
                                ...
                                <input id="predostavena_hladilna_chanta"
                                    ...
                                    value="<?= esc($pacient['predostavena_hladilna_chanta']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="predostavena_hladilna_chanta_protokol" class="d-block">
                                ...
                                <input id="predostavena_hladilna_chanta_protokol"
                                    ...
                                    value="<?= esc($pacient['predostavena_hladilna_chanta_protokol']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_na_hospitalizacia_medicinsko_odobrenie" class="d-block">
                                ...
                                <input id="data_na_hospitalizacia_medicinsko_odobrenie"
                                    ...
                                    value="<?= esc($pacient['data_na_hospitalizacia_medicinsko_odobrenie']); ?>" >
                            </label>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="data_za_zapisvane_na_pacient" class="d-block">
                                ...
                                <input id="data_za_zapisvane_na_pacient"
                                    ...
                                    value="<?= esc($pacient['data_za_zapisvane_na_pacient']); ?>" >
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label for="reshenie_na_ekspertna_lekarska_komisia" class="d-block">
                                ...
                                <input id="reshenie_na_ekspertna_lekarska_komisia"
                                    ...
                                    value="<?= esc($pacient['reshenie_na_ekspertna_lekarska_komisia']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_za_podavane_rzok" class="d-block">
                                ...
                                <input id="data_za_podavane_rzok"
                                    ...
                                    value="<?= esc($pacient['data_za_podavane_rzok']); ?>" >
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label for="data_za_uvedomlenie_rzok" class="d-block">
                                ...
                                <input id="data_za_uvedomlenie_rzok" type="text" class="form-control form-control-user" name="data_za_uvedomlenie_rzok" value="<?= set_value('data_za_uvedomlenie_rzok'); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_na_podaden_protokol_nzok" class="d-block">
                                ...
                                <input id="data_na_podaden_protokol_nzok"
                                    ...
                                    value="<?= esc($pacient['data_na_podaden_protokol_nzok']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_poluchen_protokol_nzok" class="d-block">
                                ...
                                <input id="data_poluchen_protokol_nzok"
                                    ...
                                    value="<?= esc($pacient['data_poluchen_protokol_nzok']); ?>" >
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label for="protokol_validen" class="d-block">
                                ...
                                <input id="protokol_validen"
                                    ...
                                    value="<?= esc($pacient['protokol_validen']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_za_sledvasht_protokol" class="d-block">
                                ...
                                <input id="data_za_sledvasht_protokol"
                                    ...
                                    value="<?= esc($pacient['data_za_sledvasht_protokol']); ?>" >>
                            </label>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="dni_na_pyrva_RP" class="d-block">
                                ...
                                <input id="dni_na_pyrva_RP"
                                    ...
                                    placeholder="Моля, въведете дата"
                                    aria-label="Календар"
                                    name="dni_na_pyrva_RP" value="<?= esc($pacient['dni_na_pyrva_RP']); ?>" >
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <label for="data_raredis" class="d-block">
                                ...
                                <input id="data_raredis"
                                    ...
                                    placeholder="Моля, въведете дата"
                                    aria-label="Календар"
                                    name="data_raredis" value="<?= esc($pacient['data_raredis']); ?>" >
                            </label>
                        </div>
                    </div>
